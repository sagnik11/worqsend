...
# sign the app
codesign --deep --force --verbose --options runtime --sign "36F60C6744929E06BA64EB7463B7AFFCEFF49DD0" build/macos/Build/Products/Release/WorqSend.app

# create dmg
# if appdmg is not installed yet: npm install -g appdmg
appdmg scripts/dmg/config.json WorqSend.dmg

# send to apple for notarization
DEV_EMAIL=developer@example.com
APP_PASSWORD=abcd-efgh-ijkl-mnop
NOTARIZE_OUTPUT=$(xcrun altool --notarize-app --primary-bundle-id "org.WorqSend.WorqSendApp" --username $DEV_EMAIL --password $APP_PASSWORD --file WorqSend.dmg)
...
echo "xcrun stapler staple WorqSend.dmg"

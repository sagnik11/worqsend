...
import 'package:WorqSend_app/model/state/nearby_devices_state.dart';
...
import 'package:WorqSend_app/provider/network/multicast_provider.dart';
import 'package:WorqSend_app/provider/security_provider.dart';
import 'package:WorqSend_app/util/api_route_builder.dart';
import 'package:WorqSend_app/util/task_runner.dart';

/// This provider is responsible for:
/// - Scanning the network for other WorqSend instances
...
class NearbyDevicesNotifier extends Notifier<NearbyDevicesState> {
  ...
  /// It just sends an announcement which will cause a response on every other WorqSend member of the network.

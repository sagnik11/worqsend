...
final _lightInputColor = Color.lerp(Colors.blue.shade100, Colors.white, 0.4)!;
final _lightInputBorder = OutlineInputBorder(
  borderSide: BorderSide(color: _lightInputColor),
  borderRadius: _borderRadius,
);

final _darkInputColor = Color.lerp(Colors.blue.shade100, Colors.black, 0.6)!;
...
ThemeData getTheme(Brightness brightness) {
  return ThemeData(
    ...
    // https://github.com/WorqSend/WorqSend/issues/52

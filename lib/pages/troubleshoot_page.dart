...
import 'package:WorqSend_app/util/native/cmd_helper.dart';
import 'package:WorqSend_app/util/native/platform_check.dart';
import 'package:WorqSend_app/widget/custom_icon_button.dart';
import 'package:WorqSend_app/widget/dialogs/not_available_on_platform_dialog.dart';
            ...
            primaryButton: _FixButton(
              ...
              onTapMap: {
                TargetPlatform.windows: _CommandFixAction(
                  ...
                  commands: [
                    'netsh advfirewall firewall add rule name="WorqSend" dir=in action=allow protocol=TCP localport=${settings.port}',
                    'netsh advfirewall firewall add rule name="WorqSend" dir=in action=allow protocol=UDP localport=${settings.port}',
                  ],
                ),
              },
            ),

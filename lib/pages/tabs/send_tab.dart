...
import 'package:WorqSend_app/model/send_mode.dart';
import 'package:WorqSend_app/model/session_status.dart';
import 'package:WorqSend_app/pages/progress_page.dart';
import 'package:WorqSend_app/pages/selected_files_page.dart';
import 'package:WorqSend_app/pages/send_page.dart';
import 'package:WorqSend_app/pages/troubleshoot_page.dart';
import 'package:WorqSend_app/pages/web_send_page.dart';
import 'package:WorqSend_app/provider/network/nearby_devices_provider.dart';
import 'package:WorqSend_app/provider/network/scan_provider.dart';
import 'package:WorqSend_app/provider/network/send_provider.dart';
import 'package:WorqSend_app/provider/network_info_provider.dart';
import 'package:WorqSend_app/provider/progress_provider.dart';
import 'package:WorqSend_app/provider/selection/selected_sending_files_provider.dart';
import 'package:WorqSend_app/provider/settings_provider.dart';
import 'package:WorqSend_app/util/file_size_helper.dart';
import 'package:WorqSend_app/util/native/file_picker.dart';
import 'package:WorqSend_app/util/native/ios_network_permission_helper.dart';
import 'package:WorqSend_app/util/native/platform_check.dart';
import 'package:WorqSend_app/widget/big_button.dart';
import 'package:WorqSend_app/widget/custom_icon_button.dart';
import 'package:WorqSend_app/widget/dialogs/add_file_dialog.dart';
import 'package:WorqSend_app/widget/dialogs/address_input_dialog.dart';
import 'package:WorqSend_app/widget/dialogs/no_files_dialog.dart';
import 'package:WorqSend_app/widget/dialogs/send_mode_help_dialog.dart';
import 'package:WorqSend_app/widget/file_thumbnail.dart';
import 'package:WorqSend_app/widget/list_tile/device_list_tile.dart';
import 'package:WorqSend_app/widget/list_tile/device_placeholder_list_tile.dart';
import 'package:WorqSend_app/widget/opacity_slideshow.dart';
import 'package:WorqSend_app/widget/responsive_list_view.dart';
import 'package:WorqSend_app/widget/rotating_widget.dart';
      ...
      child: Material(
        ...
        child: DividerTheme(
          data: DividerThemeData(
            color: Theme.of(context).brightness == Brightness.light ? Colors.blue.shade100 : Colors.blue.shade700,
          ),
